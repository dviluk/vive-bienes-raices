...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/hero/habitacion.jpeg" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item ">
            <img src="images/hero/habit.jpeg" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item ">
            <img src="images/hero/sala.jpeg" class="d-block w-100" alt="...">
            <div style=" position: absolute; width: 100%; height: 100%; top: 0; " class="d-flex justify-content-center align-items-center">
                <div class=" animated slideInUp text-center">
                    <a href="{{route('contact')}}#contact-form-title" class="btn">¿Desea agendar una cita?</a>
                </div>
        ...
        <div class="carousel-item ">
            <img src="images/hero/roof.jpeg" class="d-block w-100" alt="...">
            <div style=" position: absolute; width: 100%; height: 100%; top: 0; " class="d-flex justify-content-center align-items-center">
                <div class=" animated slideInUp text-center">
                    <a href="{{route('contact')}}#contact-form-title" class="btn">¿Desea agendar una cita?</a>
                </div>
